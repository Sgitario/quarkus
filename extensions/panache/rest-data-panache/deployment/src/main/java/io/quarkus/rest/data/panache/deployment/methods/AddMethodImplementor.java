...
public final class AddMethodImplementor extends StandardMethodImplementor {
    ...
    public AddMethodImplementor(boolean withValidation, boolean isResteasyClassic, boolean hasLinksEnabled) {
    ...
    protected void implementInternal(ClassCreator classCreator, ResourceMetadata resourceMetadata,
        ...
        if (isResteasyClassic()) {
            ...
            tryBlock.returnValue(resourceCreated(tryBlock, entity));
            tryBlock.close();
        } else {
            ...
            methodCreator.returnValue(UniImplementor.map(methodCreator, uniEntity, EXCEPTION_MESSAGE,
                    (body, item) -> body.returnValue(resourceCreated(body, item))));
        }
