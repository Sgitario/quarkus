...
public final class UpdateMethodImplementor extends StandardMethodImplementor {
    ...
    public UpdateMethodImplementor(boolean withValidation, boolean isResteasyClassic, boolean hasLinksEnabled) {
    ...
    private void implementReactiveVersion(MethodCreator methodCreator, ResourceMetadata resourceMetadata, ResultHandle resource,
        ...
        methodCreator
                .returnValue(UniImplementor.flatMap(methodCreator, uniResponse, EXCEPTION_MESSAGE, (getBody, itemFound) -> {
                    BranchResult ifGetEntityIsNull = getBody.ifNull(itemFound);
                    ifGetEntityIsNull.trueBranch().returnValue(UniImplementor.createFrom(ifGetEntityIsNull.trueBranch(),
                            ResponseImplementor.notFound(ifGetEntityIsNull.trueBranch())));
                    ...
                    getBody.returnValue(UniImplementor.map(getBody, uniUpdateEntity, EXCEPTION_MESSAGE,
                            (updateBody, itemUpdated) -> updateBody.returnValue(ResponseImplementor.noContent(updateBody))));
                }));
    }
    ...
    private void implementClassicVersion(MethodCreator methodCreator, ResourceMetadata resourceMetadata, ResultHandle resource,
        ...
        createdNewEntity.trueBranch().returnValue(resourceCreated(createdNewEntity.trueBranch(), newEntity));
